...
namespace AuctionService.IntegrationTests
{
    ...
    public class AuctionControllerTests : IAsyncLifetime
    {
        ...
        [Fact]
        public async Task GetAuctionById_WithInvalidGuidShouldReturnBadRequest()
        {
            // arrange ?
        ...
        [Fact]
        public async Task CreateAuction_WithNoAuthorization_ShouldReturnNotAuthorized()
        {
            // arrange ?
        ...
        [Fact]
        public async Task CreateAuction_WithAuthorization_ShouldReturnCreated()
        {
            // arrange ?
        ...
        public async Task UpdateAuction_WithValidUpdateDtoAndUser_ShouldReturnOk()
        {
            ...
            var result = await _httpClient.PutAsJsonAsync($"api/auctions/{GT_ID}", updateAuction);
