...
namespace AuctionService.UnitTests
{
    public class AuctionControllerTests
    {
        ...
        public AuctionControllerTests()
        {
            ...
            _auctionController = new AuctionsController(_auctionRepository.Object, _mapper, _publishEndpoint.Object)
            {
        ...
        public async Task GetAuctionById_WithInvalidGuid_ReturnsNotFound()
        {
            ...
            // act
            var result = await _auctionController.GetAuctionById(It.IsAny<Guid>());
        ...
        public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
        {
            ...
            var result = await _auctionController.UpdateAuction(It.IsAny<Guid>(), updatedAuction);
